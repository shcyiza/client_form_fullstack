...
<div>
    ...
    <form>
        ...
        <template v-else-if="shouldRegister">
            <h2>Registration</h2>
            <input type="text" class="input auth-input is-success" placeholder="First name" v-model="user.first_name" />
            <input type="text" class="input auth-input is-success" placeholder="Last name" v-model="user.last_name" />
            <input type="tel" class="input auth-input is-success" placeholder="phone number" v-model="user.phone" />
            <button @click.prevent="registerUser"> Register </button>
        </template>
        <template v-else-if="verifyToken">
            <h2>Validate Token</h2>
            <input type="text" class="input auth-input  is-info" placeholder="token" v-model="claim_token" />
